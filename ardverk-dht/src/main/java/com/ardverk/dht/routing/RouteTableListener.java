...
public interface RouteTableListener {
    ...
    public void handleContactReplaced(Bucket bucket, IContact existing, IContact contact);
    
    public void handleContactChanged(Bucket bucket, IContact existing, IContact contact);
