...
public class ContactTest {
    ...
    public void equals() {
        ...
        Contact contact2 = new Contact(Type.SOLICITED, 
                contact1.getId(), 
                0, new InetSocketAddress("www.microsoft.com", 3000));
        
        Contact contact3 = new Contact(Type.SOLICITED, 
                KUID.createRandom(20), 
                0, new InetSocketAddress("www.google.com", 4000));
